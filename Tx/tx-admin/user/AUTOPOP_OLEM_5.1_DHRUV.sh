...
# Check and make what is needed
  if [[ ! -d $WORKINGDIR ]]; then
     ...
     cd $SETUPDIR
     git clone git@10.141.252.223:CLAIMS-IT-02/OLEM.git --branch 5.1 --single-branch
...
# 7) Push changes to remote repo
	...
	echo ""
	echo "Push to remote completed - this is the Dhruv script."
	echo ""
